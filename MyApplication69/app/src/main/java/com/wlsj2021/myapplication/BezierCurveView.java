 ...
 */
class TowBean {
    public double TowControlPointX = 50;
    public double TowControlPoinY = 50;
}

class ThreeBean {
    public double ThreeControlPointX1 = 200;//控制点1 x坐标
    public double ThreeControlPointY1 = 300;//控制点2 y坐标

    public double ThreeControlPointX2 = 400;///控制点2 x坐标
    public double ThreeControlPointY2 = 300;//控制点2 y坐标
}
