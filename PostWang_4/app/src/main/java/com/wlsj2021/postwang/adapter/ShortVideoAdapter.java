...
import com.wlsj2022.wlsj.shortvideos.VideoLoadingProgressbar;
import com.wlsj2022.wlsj.shortvideos.VideoPlayAdapter;
import com.wlsj2022.wlsj.shortvideos.VideoPlayer;


public class ShortVideoAdapter extends VideoPlayAdapter<ShortVideoAdapter.ViewHolder> {
    ...
    public ShortVideoAdapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.short_video_item, parent, false);
