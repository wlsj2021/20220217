...
import com.wlsj2021.myapplication.videos.VideoPlayAdapter;
import com.wlsj2021.myapplication.videos.shortvideo.view.VideoLoadingProgressbar;


public class ShortMainAdapter extends VideoPlayAdapter<ShortMainAdapter.ViewHolder> {
    ...
    public ShortMainAdapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.duan_item_main, parent, false);
