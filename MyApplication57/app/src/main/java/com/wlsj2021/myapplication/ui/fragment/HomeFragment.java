...
import com.wlsj2021.myapplication.Custom.interpolator.ElasticScaleInterpolator;
import com.wlsj2021.myapplication.R;
import com.wlsj2021.myapplication.adapter.ArticleAdapter;
import com.wlsj2021.myapplication.base.fragment.BaseFragment;
import com.wlsj2021.myapplication.base.utils.Constant;
import com.wlsj2021.myapplication.base.utils.GlideImageLoader;
...
import com.wlsj2021.myapplication.presenter.home.HomePresenter;

import com.wlsj2021.myapplication.ui.activity.SearchWordActivity;
...
public class HomeFragment extends BaseFragment<Contract.IHomeView, HomePresenter> implements Contract.IHomeView,
    ...
    @Override
    public void loadBanner(List<com.wlsj2021.myapplication.bean.db.Banner> bannerList) {
        if (bannerList != null) {
    ...
    @Override
    public void refreshBanner(List<com.wlsj2021.myapplication.bean.db.Banner> bannerList) {
