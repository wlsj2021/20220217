...
import com.wlsj2021.myapplication.videos.shortvideo.ShortVideoActivity;
 ...
 * Time: 21:41
 */
public class ShortVideoFragment extends BaseFragment<Contract.IHomeSquareView, HomeSquarePresenter> implements Contract.IHomeSquareView,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        startActivity(new Intent(getActivity(), ShortVideoActivity.class));
