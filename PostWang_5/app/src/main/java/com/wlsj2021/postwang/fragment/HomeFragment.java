...
import com.wlsj2021.postwang.adapter.ArticleAdapter;
import com.wlsj2021.postwang.base.BaseFragment;
import com.wlsj2021.postwang.base.Constant;
import com.wlsj2021.postwang.base.ElasticScaleInterpolator;
...
import com.wlsj2021.postwang.contract.home.Contract;
import com.wlsj2021.postwang.custom.GlideImageLoader;
import com.wlsj2021.postwang.entity.collect.Collect;
import com.wlsj2021.postwang.entity.db.Article;
import com.wlsj2021.postwang.presenter.HomePresenter;
...
//            startActivity(intent);
    ...
    @Override
    protected void init() {
        mRecyclerView = mRootView.findViewById(R.id.article_recycler);
        mSmartRefreshLayout = mRootView.findViewById(R.id.refresh_layout);
        mNestedScrollView = mRootView.findViewById(R.id.nest_scroll);
        mToolbar = mRootView.findViewById(R.id.home_toolbar);
        mTwoLevelHeader = mRootView.findViewById(R.id.second_header);
        mSecondFloor = mRootView.findViewById(R.id.second_floor_content);
        mLayoutError = mRootView.findViewById(R.id.layout_error);
        mNormalView = mRootView.findViewById(R.id.normal_view);
//
    ...
    @Override
    public void loadBanner(List<com.wlsj2021.postwang.entity.db.Banner> bannerList) {
        if (bannerList != null) {
    ...
    @Override
    public void refreshBanner(List<com.wlsj2021.postwang.entity.db.Banner> bannerList) {
