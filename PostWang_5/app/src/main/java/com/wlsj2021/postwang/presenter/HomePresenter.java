...
import com.wlsj2021.postwang.entity.db.Banner;
import com.wlsj2021.postwang.model.HomeModel;
        ...
        iHomeModel.loadBanner()
                ...
                .subscribe(new Observer<List<Banner>>() {
                    ...
                    public void onNext(List<Banner> bannerList) {
                        if (isViewAttached()) {
                            Log.e("TAG", "onNext: _____________"+bannerList );
                    ...
                    public void onError(Throwable e) {
                        e.printStackTrace();
                        Log.e("TAG", "onNext: _____________"+e );
