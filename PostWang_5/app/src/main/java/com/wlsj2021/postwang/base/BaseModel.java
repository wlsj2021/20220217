        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (mSaveCookie) {
                ...
                if (!headers.isEmpty()) {
                    ...
                    SharePreferencesStore.getInstance("cookie").put("user", sb.toString());
                    SharePreferencesStore.getInstance("cookie").put("cookie_expire", System.currentTimeMillis() + 30 * 24 * 3600 * 1000L);
                }
            }
            return response;
        }
