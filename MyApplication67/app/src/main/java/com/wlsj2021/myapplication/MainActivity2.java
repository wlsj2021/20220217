...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoPlayer.setUp("http://godmusic.bs2dl.yy.com/dHYyZmUyNjBjOTU5ZGM0ODVhYmUzNTVhNmZkY2M0YzA5MC0xMzcxNjAzMDYz",false,"测试");
        videoPlayer.startPlayLogic();




        danmakuView =  findViewById(R.id.dan_view);
